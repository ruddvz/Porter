...
export default function TopBar({
  ...
  return (
    <header className="safe-top sticky top-0 z-30 flex min-h-14 shrink-0 items-center gap-3 border-b border-porter-bg-border bg-porter-bg-surface/95 px-3 shadow-[0_1px_0_var(--po-line)] backdrop-blur lg:px-4">
      <button
        type="button"
